...
public class Edge3 {
    ...
    static int[] factX = { 1, 1, 1, 6 / 2, 24 / 2, 120 / 2, 720 / 2, 5040 / 2, 40320 / 2, 362880 / 2, 3628800 / 2, 39916800 / 2, 479001600 / 2 };
    static int done = 0;
    static int[] FullEdgeMap = { 0, 2, 4, 6, 1, 3, 7, 5, 8, 9, 10, 11 };
    private static final Logger logger = LoggerFactory.getLogger(Edge3.class);
